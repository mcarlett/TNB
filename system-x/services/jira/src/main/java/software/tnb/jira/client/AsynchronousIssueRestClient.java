...
public class AsynchronousIssueRestClient extends AbstractAsynchronousRestClient implements IssueRestClient {
    ...
    @Override
    public Promise<Iterable<CimProject>> getCreateIssueMetadata(GetCreateIssueMetadataOptions options) {
    ...
    @Override
    public Promise<Page<IssueType>> getCreateIssueMetaProjectIssueTypes(final String projectIdOrKey, final Long startAt,
    ...
    @Override
    public Promise<Page<CimFieldInfo>> getCreateIssueMetaFields(final String projectIdOrKey, final String issueTypeId,
        final Long startAt, final Integer maxResults) {
    ...
    private void addPagingParameters(UriBuilder uriBuilder, Long startAt, Integer maxResults) {
        if (startAt != null) {
